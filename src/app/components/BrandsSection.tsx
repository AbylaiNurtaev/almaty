...
const CATS = [
  {
    cat: "Игровая периферия", color: "#00D4F5", count: "05",
    brands: ["Dark Project", "AULA", "MCHOSE", "Redragon", "Havit"],
  },
  {
    cat: "Железо и мониторы", color: "#6B21E8", count: "09",
    brands: ["MSI", "AOC", "Samsung", "Lenovo", "Dell", "Alienware", "PCcooler", "Ocypus", "XPG"],
  },
  {
    cat: "Софт для клубов", color: "#E8A800", count: "04",
    brands: ["Enestech", "Langame", "Smartshell", "Gizmo"],
  },
  {
    cat: "Банковские партнёры", color: "#00C875", count: "04",
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-12 mb-14">
          ...
          <div style={{ paddingBottom: "8px" }}>
            ...
            <div className="flex" style={{ gap: "1px", background: "rgba(255,255,255,0.06)" }}>
              {[{ v: "40+", l: "Брендов" }, { v: "4", l: "Категорий" }, { v: "2", l: "Дня" }].map((s) => (
